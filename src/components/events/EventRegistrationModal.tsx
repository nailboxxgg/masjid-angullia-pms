                    ...
                    <div>
                        ...
                        <div className="flex">
                            ...
                            <input
                                ...
                                type="tel"
                                value={contact}
                                onChange={(e) => setContact(e.target.value.replace(/\D/g, ''))} // Digits only
                                className="flex-1 w-full px-3 py-2 border border-secondary-300 rounded-r-md focus:ring-2 focus:ring-primary-500 focus:outline-none"
